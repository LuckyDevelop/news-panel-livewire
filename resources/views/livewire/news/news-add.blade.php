<div class="card">
    <div class="card-body">
        <form class="multisteps-form__form" style="height: 391px;" wire:submit.prevent="create">
                ...
                <div class="row mt-3">
                    <div class="col-12 col-sm-6">
                        <div class="input-group input-group-dynamic">
                            ...
                            <input class="form-control" type="text" onfocus="focused(this)"
                                onfocusout="defocused(this)" wire:model.live="title">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                        <div class="input-group input-group-dynamic">
                            ...
                            <input class="form-control" type="text" onfocus="focused(this)"
                                onfocusout="defocused(this)" wire:model.live="content">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                        <div class="input-group input-group-dynamic">
                            ...
                            <input class="form-control" type="text" onfocus="focused(this)"
                                onfocusout="defocused(this)" wire:model.live="author">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                        <div class="input-group input-group-dynamic">
